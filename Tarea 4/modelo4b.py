...
class Model4b(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            'INPUT': '/Users/malenahedemann/Desktop/Clases herramientas/Clase 4/ne_10m_coastline/ne_10m_coastline.shp',
        ...
        outputs['DropFieldsFixgeo_coats'] = processing.run('native:deletecolumn', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['Coastout'] = outputs['DropFieldsFixgeo_coats']['OUTPUT']
        ...
        alg_params = {
            'COLUMN': ['fid','cat','xcoord','ycoord','fid_2','cat_2','vertex_index','vertex_part','vertex_part','_index','angle','xcoord_2','ycoord_2'],
        ...
        alg_params = {
            'COLUMN': ['xcoord','ycoord','fid_2','cat_2','xcoord_2','ycoord_2','vertex_index','vertex_part','vertex_part_index'],
            'INPUT': 'Calculated_ae0b1c94_7d6e_4b25_9a1b_b68769446db2',
